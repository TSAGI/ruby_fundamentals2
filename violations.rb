...
for category in violation_categories    
    puts "There were #{violations.count {|hash_element| hash_element[:violation_category] == category }} violations in the #{category} category."
end
...
for category in violation_categories
    ...
    puts "The total money owed for #{category} is $%.2f" % total_owed
end
